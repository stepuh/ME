...
public class Client15 {
	...
	public static void main(String[] args){
		...
		double[] i00 = {0,0}; double[] o00= {0}; Muster m_00 = new Muster(i00,o00); musterAND.add(m_00);
		double[] i01 = {0,1}; double[] o01= {0}; Muster m_01 = new Muster(i01,o01); musterAND.add(m_01);
		double[] i02 = {1,0}; double[] o02= {0}; Muster m_02 = new Muster(i02,o02); musterAND.add(m_02);
		double[] i03 = {1,1}; double[] o03= {1}; Muster m_03 = new Muster(i03,o03); musterAND.add(m_03);
		...
		double[] i10 = {0,0}; double[] o10= {0}; Muster m_10 = new Muster(i10,o10); musterOR.add(m_10);
		double[] i11 = {0,1}; double[] o11= {1}; Muster m_11 = new Muster(i11,o11); musterOR.add(m_11);
		double[] i12 = {1,0}; double[] o12= {1}; Muster m_12 = new Muster(i12,o12); musterOR.add(m_12);
		double[] i13 = {1,1}; double[] o13= {1}; Muster m_13 = new Muster(i13,o13); musterOR.add(m_13);

		
		System.out.println("AND:");
		System.out.println("Noch nicht gelernt. Neuron schießt folgende Outputs zu diesen Inputs: 00, 01, 10, 11:");
		...
		System.out.println("Habe Gewichte: w0 = " + w0 + ", w1 = " + w1+", bias = "+bias);
		System.out.println("Neuron schießt folgende Outputs zu diesen Inputs: 00, 01, 10, 11:");
		netzAND.ergebnisZuMuster_all(musterAND);
